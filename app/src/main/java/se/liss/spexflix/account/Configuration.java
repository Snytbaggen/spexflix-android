...
public final class Configuration {
    ...
    public static se.liss.spexflix.account.Configuration getInstance(Context context) {
        se.liss.spexflix.account.Configuration config = sInstance.get();
        if (config == null) {
            config = new se.liss.spexflix.account.Configuration(context);
