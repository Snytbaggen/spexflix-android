...
public class AuthStateManager {
    ...
    @AnyThread
    public static se.liss.spexflix.account.AuthStateManager getInstance(@NonNull Context context) {
        se.liss.spexflix.account.AuthStateManager manager = INSTANCE_REF.get().get();
        if (manager == null) {
            manager = new se.liss.spexflix.account.AuthStateManager(context.getApplicationContext());
